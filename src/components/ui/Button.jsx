...
const Button = React.forwardRef(({ text, className, isBookMeeting = false, onClick }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full overflow-hidden flex items-center justify-center z-10 px-1">
        {/* Transparent text to define the button's width */}
        ...
        <div className="absolute inset-0 h-[200%] flex flex-col transition-transform duration-500 cubic-bezier(0.4, 0, 0.2, 1) group-hover:-translate-y-1/2">
          ...
          <div className="h-1/2 flex items-center justify-center whitespace-nowrap">
            {text}
          </div>
